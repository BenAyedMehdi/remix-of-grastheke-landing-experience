  ...
  head: () => ({
    meta: [
      ...
      { title: "Grastheke — Medizinisches Cannabis aus Partnerapotheken" },
      {
        name: "description",
        content:
          "Grastheke: medizinisches Cannabis über geprüfte Partnerapotheken in Deutschland. Standort wählen, Sortiment ansehen, im Shop bestellen.",
      },
      { name: "author", content: "Grastheke" },
      { property: "og:title", content: "Grastheke — Medizinisches Cannabis" },
      {
        property: "og:description",
        content: "Verlässlich, regional, pharmazeutisch begleitet.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Instrument+Sans:ital,wght@0,400..700;1,400..600&display=swap",
      },
